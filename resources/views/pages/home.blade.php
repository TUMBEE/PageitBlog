...
@section('page_title', 'Page It Blog')
@php
    $perPage = 12;
...
<div class="col-md-4 d-flex align-items-stretch mb-4">
    <div class="card">
        <div>
            <a class="text-black" href="/p{{ $entry->url() }}">
                <img src="{{ $entry->blog_featured_image }}" class="card-img-top br-0" style="border-radius: 0px">
            </a>
    ...
    @if ($loopCounter % 3 === 0 && $loopCounter < count($entries))
        <hr class="blog-row">
    @endif
@endforeach
...
<div class="pagination-container">
    <ul class="pagination">
        ...
        @if ($entries->hasMorePages())
            <li class="page-item"><a class="page-link" href="{{ $entries->nextPageUrl() }}">&raquo;</a></li>
        @else
